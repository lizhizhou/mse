...
//altufm_parallel ACCESS_MODE="READ_WRITE" CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="MAX II" ERASE_TIME=500000000 OSC_FREQUENCY=180000 PROGRAM_TIME=1600000 WIDTH_ADDRESS=9 WIDTH_DATA=16 WIDTH_UFM_ADDRESS=9 addr data_valid datain dataout nbusy nerase nread nwrite osc oscena
//VERSION_BEGIN 12.1SP1 cbx_a_gray2bin 2013:01:31:18:04:57:SJ cbx_a_graycounter 2013:01:31:18:04:57:SJ cbx_altufm_parallel 2013:01:31:18:04:59:SJ cbx_cycloneii 2013:01:31:18:04:59:SJ cbx_lpm_add_sub 2013:01:31:18:04:59:SJ cbx_lpm_compare 2013:01:31:18:04:59:SJ cbx_lpm_counter 2013:01:31:18:04:59:SJ cbx_lpm_decode 2013:01:31:18:04:59:SJ cbx_lpm_mux 2013:01:31:18:04:59:SJ cbx_maxii 2013:01:31:18:04:59:SJ cbx_mgl 2013:01:31:18:08:27:SJ cbx_stratix 2013:01:31:18:04:59:SJ cbx_stratixii 2013:01:31:18:04:59:SJ cbx_util_mgl 2013:01:31:18:04:59:SJ  VERSION_END
...
module  flash_altufm_parallel_71o
	( 
	addr,
	data_valid,
	datain,
	...
	nwrite,
	osc,
	oscena) /* synthesis synthesis_clearbox=2 */;
	input   [8:0]  addr;
	output   data_valid;
	input   [15:0]  datain;
	output   [15:0]  dataout;
...
`endif
	...
	assign
		...
		Z_var = (X_var | Y_var);
endmodule //flash_altufm_parallel_71o
//VALID FILE
...
module flash (
	...
	dataout,
	nbusy,
	osc)/* synthesis synthesis_clearbox = 2 */;
	...
	wire  nbusy = sub_wire1;
	wire  osc = sub_wire2;
	wire [15:0] dataout = sub_wire3[15:0];

	flash_altufm_parallel_71o	flash_altufm_parallel_71o_component (
				.addr (addr),
				.datain (datain),
				.nwrite (nwrite),
				.oscena (oscena),
				...
				.nbusy (sub_wire1),
				.osc (sub_wire2),
				.dataout (sub_wire3))/* synthesis synthesis_clearbox=2
